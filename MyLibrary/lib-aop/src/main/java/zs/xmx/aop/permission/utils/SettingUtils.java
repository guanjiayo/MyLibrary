package zs.xmx.aop.permission.utils;

import android.content.Context;
import android.os.Build;

import zs.xmx.aop.permission.callback.ISetting;
import zs.xmx.aop.permission.support.Default;
import zs.xmx.aop.permission.support.HuaWei;
import zs.xmx.aop.permission.support.LG;
import zs.xmx.aop.permission.support.Letv;
import zs.xmx.aop.permission.support.MeiZu;
import zs.xmx.aop.permission.support.OPPO;
import zs.xmx.aop.permission.support.QiHu;
import zs.xmx.aop.permission.support.VIVO;
import zs.xmx.aop.permission.support.XiaoMi;
