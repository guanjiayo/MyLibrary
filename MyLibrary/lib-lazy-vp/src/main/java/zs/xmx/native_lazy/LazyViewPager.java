 ...
 * @创建时间   2016/11/10 17:24
 * @本类描述	  LazyViewPager
 * @内容说明   防止ViewPager预加载
 * @补充内容  ViewPager的源码,只是将默认1改为0
 * @步骤:
 *       1.新建LazyViewPager 类,把上面的源码  拷贝进去
 *       2.把原来继承ViewPager的类,修改成继承LazyViewPager ,对应的ViewPager 控件 也改成 LazyViewPager
 * ---------------------------------     
 * @新增内容
 *
 */
...
public class LazyViewPager extends ViewGroup {
    ...
    //默认的加载页面,ViewPager是1个,所以会加载两个Fragment,设置为0去掉预加载
    ...
    /**
     * Simple implementation of the {@link androidx.core.view.LazyViewPager.OnPageChangeListener} interface with stub
     * implementations of each method. Extend this if you do not intend to override
     * every method of {@link androidx.core.view.LazyViewPager.OnPageChangeListener}.
     */
